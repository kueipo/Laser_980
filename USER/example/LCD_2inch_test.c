...
void LCD_2in_test()
{
	LCD_log_info("LCD_2IN_test Demo\r\n");
	DEV_Module_Init();

	LCD_log_info("LCD_2IN_ Init and Clear...\r\n");
	LCD_2IN_Init();
//	LCD_2IN_Clear(WHITE);
	LCD_2IN_SetBackLight(BRIGHTNESS_LEVELS_100);

//	LCD_log_info("Paint_NewImage\r\n");
//	Paint_NewImage(LCD_2IN_WIDTH, LCD_2IN_HEIGHT, ROTATE_180, WHITE);

//	LCD_log_info("Set Clear and Display Funtion\r\n");
...
//	Paint_SetDisplayFuntion(LCD_2IN_DrawPaint);
	...
	//	Paint_DrawString_EN (5,170, "Icbtech",    &Font24,    WHITE,   BLUE);
	//	Paint_DrawString_CN (5,190, "Icbtech",    &Font24CN,  WHITE,   RED);
