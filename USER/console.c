...
//							ch = 0x5A;
//							if (fal_partition_write(env, 0, (uint8_t *)&ch, 1) >= 0)
//								cpu_reset(); //重启
//						}
//						break;
//					case 1:
...
//	#include "Task/Task.h"
//	Enable_Task(REFRESH_TIME);

//	extern BTN_STRUCT Btn;
//	if (Btn.ui_idx == PAGEPOWER)
//	{
//		pTime = &time;
...
//	#include "Task/Task.h"
//	
//	extern void Enable_Task(uint8_t index);
//	Enable_Task(REFRESH_TIME);
//	Enable_Task(REFRESH_POWER);
//}
