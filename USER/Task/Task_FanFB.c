...
#define FAN_OFFSET_DATA_CONTENT_START		(uint8_t)(FAN_OFFSET_STEP + FAN_OFFSET_DATA_LENGTH)		/* 05 */
...
//		Fan_OptTemperatureVal(WRITE, index, val);
	}
#else
	UNUSED(arg);
#endif
...
//		APP_Fan_OptSpeedVal(WRITE, FAN_MODULE_1, index, val);
	}
}
