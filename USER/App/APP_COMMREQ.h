...
#define INDEX_SMALL_HANDLE				(uint8_t)0X83
...
/* FAN */
#define DEV_INDEX_FAN							(uint8_t)(0X40)
...
#define INDEX_TARGET_FAN_SPEED 		TARGET_LENGTH + INDEX_TARGET_FAN_POWER_AUTO				/* 03 */
#define INDEX_TARGET_FAN_NUMBER		TARGET_LENGTH + INDEX_TARGET_FAN_SPEED						/* 04 */
...
#define INDEX_TARGET_WATER_TEMPERATURE	(uint8_t)(TARGET_LENGTH + INDEX_SET_TEMP_THRESHOLD)
																																												/* 0x03 */
...
#define INDEX_TARGET_COOLER				(uint8_t)(TARGET_LENGTH + INDEX_TARGET_WATER_LEVEL)		/* 0x07 */
#define INDEX_ICO_COOLER					INDEX_TARGET_COOLER
#define INDEX_LASER_PULSE					(uint8_t)(TARGET_LENGTH + INDEX_TARGET_COOLER)				/* 0x08 */
...
#define INDEX_TARGET_LASERCOUNT_MODIFY	(uint8_t)(TARGET_LENGTH + INDEX_LASER_POWER)		/* 0x0B */
...
#define INDEX_FACTORY							(uint8_t)(TARGET_LENGTH + INDEX_SAFELOCKER_PROTECT)		/* 0x13 */
#define INDEX_LASER_CW_MODE				INDEX_FACTORY
#define INDEX_LED_CONFIG					(uint8_t)(TARGET_LENGTH + INDEX_FACTORY)							/* 0x14 */
...
#define INDEX_DC05_INFO						(uint8_t)(TARGET_LENGTH + INDEX_LASER_INDICATOR_POWER)
																																												/* 0x22 */
...
#define GET_VERSION_MS_J_A				(uint8_t)(TARGET_START_ADDR + 0x60)									/* 0x60 */		

#define INDEX_ERROR_CODE					INDEX_TARGET_UPDATA - TARGET_LENGTH				/* FB */
#define INDEX_TARGET_UPDATA				INDEX_TARGET_PRODUCT_DATE - TARGET_LENGTH	/* FC */
#define INDEX_TARGET_PRODUCT_DATE	INDEX_BSP_VERSION - TARGET_LENGTH					/* FD */
#define INDEX_BSP_VERSION					INDEX_SYSTEMRESET - TARGET_LENGTH					/* FE */
