...
#endif
#define FT5206_log_d(...)                                           \
	FT5206_LOG_PRINTF("[D][CTP] (%s:%d) ", __FUNCTION__, __LINE__); \
	FT5206_LOG_PRINTF(__VA_ARGS__);                                 \
	FT5206_LOG_PRINTF("\n")
#else
#ifdef assert
#undef assert
...
#define FT5206_log_err(...)                                                    \
	FT5206_LOG_PRINTF("\033[31;22m[E][CTP] (%s:%d) ", __FUNCTION__, __LINE__); \
	FT5206_LOG_PRINTF(__VA_ARGS__);                                            \
	FT5206_LOG_PRINTF("\033[0m\n")
#else
/* error level log */
#ifdef FT5206_log_err
#undef FT5206_log_err
...
#define FT5206_log_info(...)                   \
	FT5206_LOG_PRINTF("\033[32;22m[I][CTP] "); \
	FT5206_LOG_PRINTF(__VA_ARGS__);            \
	FT5206_LOG_PRINTF("\033[0m\n")
#else
/* info level log */
