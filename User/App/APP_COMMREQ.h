...
#define INDEX_LASER_PULSE_WIDTH		(uint8_t)(TARGET_LENGTH + INDEX_TARGET_WATER_LEVEL)		/* 0x07 */
#define INDEX_LASER_PULSE					(uint8_t)(TARGET_LENGTH + INDEX_LASER_PULSE_WIDTH)		/* 0x08 */
...
#define INDEX_SAFELOCKER_PROTECT	(uint8_t)(TARGET_LENGTH + INDEX_HANDPIECE_PROTECT)		/* 0x12 */
#define INDEX_LASER_MODE							(uint8_t)(TARGET_LENGTH + INDEX_SAFELOCKER_PROTECT)		/* 0x13 */
