...
{
	s_stSwitchTcb.flag.bUpdata = true;
	s_stSwitchTcb.flag.bUpdataBG = true;
	s_stSwitchTcb.flag.bUpdataIcoStart = false;
}
...
{
	if (s_stSwitchTcb.flag.bUpdata == false)
		return;
	...
	/*  */
	s_stSwitchTcb.flag.bUpdata = false;
}
...
void UI_Switch_WriteState(bool flag)
{
	...
	s_stSwitchTcb.flag.bUpdataIcoStart = true;
	s_stSwitchTcb.flag.bUpdata = true;
}
...
static void UI_Switch_BG_Init(void)
{
	if (s_stSwitchTcb.flag.bUpdataBG == false)
		return;
	...
	s_stSwitchTcb.flag.bUpdataBG = false;
}
...
static void UI_Switch_ICO_Start(void)
{
	if (s_stSwitchTcb.flag.bUpdataIcoStart == false)
		return;
