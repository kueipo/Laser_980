...
static const unsigned int ccitt_table[256] =
{
...
/**
  ...
  * \return
  */
static bool ymodem_crc16_is_correct(ymodem_t *this)
{
    bool ret = false;
    unsigned char *q;
    unsigned int len;
...
/**
  ...
  * \return
  */
static void ymodem_set_reply_code(ymodem_t *this, ymodem_code_t code)
{
...
static void ymodem_Set_result(ymodem_t *this, ymodem_result_t result)
{
    ...
    for (unsigned char i = 0; i < END_SESSION_SEND_CAN_NUM; i++)
    {
...
bool ymodem_init(ymodem_t *this)
{
    ...
    this->data.nack_retry_cnt = 0;
		...
		this->cbs.on_begin = ymodem_on_begin;
		this->cbs.on_data = ymodem_on_data;
...
/**
  ...
  * \return
  */
static bool ymodem_get_data(ymodem_t *this)
{
    unsigned char data;
    bool ret;
